document.addEventListener("DOMContentLoaded", () => {
  ...
  function showCouponPopup(data) {
    ...
    document.getElementById("travelDate").textContent = new Date(data.date).toLocaleDateString('fr-FR', {
      weekday: 'long',
      day: 'numeric',
      month: 'long'
    });
  ...
  form.addEventListener("submit", async (e) => {
    ...
    // Validation
    if (!formData.nom || !formData.numero || !formData.depart || !formData.arrivee || !formData.date) {
